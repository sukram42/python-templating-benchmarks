import tenjin
from tenjin.helpers import *  # noqa: F401, F403 — required by tenjin at render time
...
def bench_invoice(fixture: Fixture[Invoice]) -> BenchCase:
    ...
    return BenchCase(
        prepare=lambda: tenjin.Template(input=template_str),
